...
SchemaBuilderEntityProto.toJSONSchema = function() {
	...
	var self = this;
	var obj = {};
	var p = (CONF.url || 'https://schemas.snipkode.com/');
...
function RESTBuilder(url) {
	...
	this.options = { url: url, timeout: 10000, method: 'GET', resolve: true, headers: { 'user-agent': 'snipkode/v' + F.version_header, accept: 'application/json, text/plain, text/plain, text/xml' }};
...
function exec_callback(err, response) {
	...
	if (self.$schema) {
		...
		if (self.$errorbuilderhandler) {
			...
			// Is the response snipkode ErrorBuilder?
